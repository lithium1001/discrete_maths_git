...
if 'resume_data' not in st.session_state:
    st.session_state.resume_data = pd.read_csv(r'/mount/src/discrete_maths_git/期末代码_git/data/mapped_resume_dataset.csv')
if 'job_data' not in st.session_state:
    st.session_state.job_data = pd.read_csv(r'/mount/src/discrete_maths_git/期末代码_git/data/job_data_with_id.csv')
if 'random_sampled_jobs' not in st.session_state:
    st.session_state.random_sampled_jobs = pd.read_csv(r'/mount/src/discrete_maths_git/期末代码_git/data/random_sampled_jobs.csv')
